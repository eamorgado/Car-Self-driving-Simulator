...
import pygame
import datetime
from server.carla.text.help_text import HelpText
...
class HUD(object):
    def __init__(self, width, height):
        ...
        font = pygame.font.SysFont(None,20)#pygame.font.Font(pygame.font.get_default_font(), 20)
        #fonts = [x for x in pygame.font.get_fonts() if 'mono' in x]
        #default_font = 'ubuntumono'
        #mono = default_font if default_font in fonts else fonts[0]
        #mono = pygame.font.match_font(font)
        self._font_mono = font#pygame.font.Font(font, 14)
        self._notifications = FadingText(font, (width, 40), (0, height - 40))
        self.help = HelpText(font, width, height)
        self.server_fps = 0
        self.frame_number = 0
